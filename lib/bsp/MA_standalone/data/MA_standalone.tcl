...
# --------------------------------------
# Tcl procedure MA_standalone_drc
# -------------------------------------
proc MA_standalone_drc {os_handle} {
...
proc generate {os_handle} {
    ...
    # Only processor specific file should be copied to specified MA_standalone folder
...
#    print_generated_header_tcl $makeconfig "Configuration parameters for Standalone Makefile"
    ...
    if { $enable_sw_profile == "true" } {
        puts $makeconfig "LIBS = MA_standalone_libs profile_libs"
    } else {
        puts $makeconfig "LIBS = MA_standalone_libs"
    }
    close $makeconfig
    ...
    ::hsi::utils::write_c_header $bspcfg_fh "Configurations for MA Standalone BSP"
